  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        animation: "floatGate 3s ease-in-out infinite",
      }}>
        🌌
      </div>

      {/* KISMET wordmark — gold serif */}
      <h1 style={{
        margin: 0, padding: 0,
        fontSize: "clamp(42px, 12vw, 64px)",
        fontWeight: 700,
        letterSpacing: "0.18em",
        background: "linear-gradient(180deg, #f5e6a3 0%, #d4af37 40%, #b8860b 80%, #a07000 100%)",
      ...
      <p style={{
        ...
        color: "rgba(212,175,55,0.5)", fontFamily: "'Segoe UI', system-ui, sans-serif",
        fontStyle: "italic",
      }}>
        AI Character Chat
      </p>
...
function AppContent() {
  ...
  /* Show splash for at least 1.8s on first load */
  useEffect(() => {
